...
// Événement minimal accepté par onChange : compatible avec un vrai
// ChangeEvent d'<input> comme avec l'événement synthétique des boutons ±.
...
export default function ChampNumerique({ value, onChange, min, max, step = 1, className = '', ...reste }: Props) {
