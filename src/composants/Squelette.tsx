...
export function SqueletteClients({ n = 6 }: { n?: number }) {
  return (
...
function LigneSquelette({ colonnes }: { colonnes: string[] }) {
  return (
...
export function SquelettePrestations({ n = 5 }: { n?: number }) {
  return (
...
export function SqueletteModesPaiement({ n = 4 }: { n?: number }) {
  return (
