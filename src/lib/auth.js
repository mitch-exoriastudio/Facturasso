...
import { getDossierClient } from './prisma.js';
import { trouverDossier } from './licence.js';
...
export function resoudreClient(payload) {
...
export function exigerDroit(payload, nomDroit) {
